		...
		<tr>
			...
			<td>
				<div class="btn-group" role="group" aria-label="Basic example">
				  <a class="btn btn-primary" href="<?php echo '/phpMVC1/categorie/'.$categorie->getId(); ?>">Voir</a>
				  <a class="btn btn-primary" href="<?php echo '/phpMVC1/categorie/update/'.$categorie->getId(); ?>">Modifier</a>
				  <button id="btn_supp" class="btn btn-primary" data-toggle="modal" data-target="#deleteModal">Supprimer</button>
				</div>
			</td>
		</tr>
		<?php endforeach ?>
